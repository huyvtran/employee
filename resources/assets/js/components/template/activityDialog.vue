<template>
	<v-dialog :value="dialog" persistent max-width="600">
		<v-card>
			...
			<v-card-actions>
				<v-spacer></v-spacer>
				<v-btn color="red accent-3" flat @click.native="$store.commit('DIALOG_CLOSE_ACTIVITY')">Hủy</v-btn>
				<v-btn color="green darken-1" flat @click.native="save" outline>Cập nhật</v-btn>
			</v-card-actions>
		</v-card>
	</v-dialog>
</template>
